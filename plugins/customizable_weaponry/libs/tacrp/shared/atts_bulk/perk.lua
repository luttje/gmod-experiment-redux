...
PLUGIN.LoadAtt(ATT, "perk_blindfire")
-- #endregion
...
PLUGIN.LoadAtt(ATT, "perk_hipfire")
-- #endregion
...
PLUGIN.LoadAtt(ATT, "perk_reload")
-- #endregion
