...
function PANEL:SetPayment(payment, index)
	...
	trackingLabel:SetText("Tracking ID:")
	...
	self.copyButton.DoClick = function()
		...
		LocalPlayer():Notify("Tracking ID copied to clipboard!")
	end
...
function PANEL:Init()
	...
	self.searchEntry:SetPlaceholderText("Search by player name, Steam ID, or Tracking ID...")
