...
return [
    ...
    3 => [
        ...
        'description' => 'Avoid sending repeated messages, voice spam, or disruptive sounds.',
        'escalations' => [
            [
                'type' => 'mute',
                'duration_in_minutes' => 5,
                'reason' => 'Warning: Please avoid spamming or flooding chat with repeated messages or disruptive sounds. [Minor Offense]',
                'is_ai_enforcable' => true,
            ],
            [
                'type' => 'mute',
                'duration_in_minutes' => 15,
                'reason' => 'Warning: Please avoid spamming or flooding chat with repeated messages or disruptive sounds. [1st Offense]',
                'is_ai_enforcable' => true,
            ],
            [
                'type' => 'mute',
                'duration_in_minutes' => 60,
                'reason' => 'Second violation for spamming. Keep chat clear and avoid repeated or disruptive messages. [2nd Offense]',
                'is_ai_enforcable' => true,
            ],
            [
                'type' => 'ban',
                'duration_in_minutes' => 60,
                'reason' => 'Third violation for spamming or chat flooding. Please respect other players\' chat experience. [3rd Offense]',
                'is_ai_enforcable' => true,
            ],
            [
                'type' => 'ban',
                'duration_in_minutes' => 60 * 24,
                'reason' => 'Fourth violation for spamming. Continued disruptive chat behavior is unacceptable. [4th Offense]',
                'is_ai_enforcable' => true,
            ],
            [
                'type' => 'ban',
                'duration_in_minutes' => 60 * 24 * 7,
                'reason' => 'Fifth violation for spamming or flooding chat. Repeated disruptive behavior warrants extended removal. [Repeated Offense]',
                'is_ai_enforcable' => true,
            ],
            [
                'type' => 'ban',
                'duration_in_minutes' => 60 * 24 * 30,
                'reason' => 'Repeated violation of spamming policy. Continued disruptive chat behavior will result in extended removal. [Repeated Offense]',
            ],
        ],
    ],
    4 => [
