...
PLUGIN.presets = {
	...
	wall_mounted = {
		...
		spawn = function(client, trace)
			...
			local monitor = ents.Create("exp_monitor")
			monitor:SetMonitorWidth(500)
			monitor:SetMonitorHeight(400)
			monitor:SetMonitorScale(0.045)
	...
	combine_big = {
		...
		spawn = function(client, trace)
			...
			local monitor = ents.Create("exp_monitor")
			monitor:SetMonitorWidth(200)
			monitor:SetMonitorHeight(352)
			monitor:SetMonitorScale(1)
