      ...
      <body>
          ...
          <div class="wrapper my">
              ...
              <p class="mt-s">
                  ...
                  <b>Please contact us at <span class="highlight">{{privacy_email}}</span> after removing your data, so we can also remove anonymize it in our moderation system.</b>
              </p>
          </div>
          <div class="wrapper my">
          ...
          <div class="wrapper my">
              ...
              <iframe src="https://moderation.experiment.games/rules"
                      style="border: none; width: 100%; height: 500px; margin-top: 0.5em;"></iframe>
          </div>
          <div class="wrapper my">
              <h3>PREMIUM SHOP</h3>
              <p>
              ...
              <p class="mt-s italic">
                  ...
                  <span class="highlight">{{support_email}}</span>.
